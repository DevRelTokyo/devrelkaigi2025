export const meta = {
  ...
  description: "DevRelKaigi 2025 is an international DevRel conference organized by DevRel/Tokyo. It features both Japanese and English tracks and spans multiple days (3 days in 2025)."
};
